...
class CntFrame : public QFrame {
 Q_OBJECT
 public:
  CntFrame(QWidget *pnt,LocMaster *lm) : QFrame(pnt) {
   parent=pnt; p=lm; w=parent->width()-9; h=parent->height()-60;
   ...
   evtFont=QFont("Helvetica",10,QFont::Bold);
   rMatrix.rotate(-90);
  }
...
*/  }
 ...
 private:
  QWidget *parent; LocMaster *p; QString dummyString;
