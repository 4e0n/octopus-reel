...
#ifndef STRMCONTROLWINDOW_H
#define STRMCONTROLWINDOW_H
...
class StrmControlWindow : public QMainWindow {
 Q_OBJECT
 public:
  explicit StrmControlWindow(ConfParam *c=nullptr,QWidget *parent=nullptr) : QMainWindow(parent) {
 ...
 private slots:
  ...
  void slotAbout() {
   QMessageBox::about(this,"About Octopus-ReEL HyperEEG Streamer GUI Client",
