...
class EEGFrame : public QFrame {
 ...
 public:
  explicit EEGFrame(ConfParam *c=nullptr,unsigned int a=0,AudioFrame *aFrame=nullptr,
   ...
   scrollBuffer=QImage(conf->eegFrameW,conf->eegFrameH,QImage::Format_RGB32);
  ...
  bool scrollSched; QImage scrollBuffer; EEGThread *eegThread;
 ...
 protected:
  virtual void paintEvent(QPaintEvent *event) override {
   ...
   mainPainter.drawImage(0,0,scrollBuffer); scrollSched=false;
