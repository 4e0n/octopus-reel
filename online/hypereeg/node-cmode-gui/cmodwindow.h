...
class CModWindow : public QMainWindow {
 Q_OBJECT
 public:
  explicit CModWindow(ConfParam *c=nullptr,QWidget *parent=nullptr) : QMainWindow(parent) {
...
//   connect(quitAction,&QAction::triggered,this,[=](){statusBar->setText("Status: Quit Octopus Hyper CM Client");});
   ...
   for (unsigned int ampIdx=0;ampIdx<conf->ampCount;ampIdx++) {
    cmF=new CModFrame(conf,ampIdx,this);
