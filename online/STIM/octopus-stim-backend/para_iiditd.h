 ...
 if (counter2==0) {
  ...
  switch (current_pattern_data) {
   ...
   case '2': para_iiditd_current_iid_amp_l=AMP_H20; /* IID: L high, R low.. */
             ...
             para_iiditd_itd_lr_delta=0;
             if (trig_active) outb(0x80|SEC_IID_LEFT,STIM_PARBASE);
             break;
